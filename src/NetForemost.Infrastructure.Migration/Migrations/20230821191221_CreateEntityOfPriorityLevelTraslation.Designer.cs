...
namespace NetForemost.Infrastructure.Migrations.Migrations
{
    ...
    [Migration("20230821191221_CreateEntityOfPriorityLevelTraslation")]
    partial class CreateEntityOfPriorityLevelTraslation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.PriorityLevels.PriorityLevelTraslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_priority_level_traslation");

                    b.HasIndex("LanguageId")
                        .HasDatabaseName("ix_priority_level_traslation_language_id");

                    b.HasIndex("PriorityLevelId")
                        .HasDatabaseName("ix_priority_level_traslation_priority_level_id");

                    b.ToTable("priority_level_traslation", (string)null);
                });
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.PriorityLevels.PriorityLevelTraslation", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.Languages.Language", "Language")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_priority_level_traslation_language_language_id");
                    ...
                    b.HasOne("NetForemost.Core.Entities.PriorityLevels.PriorityLevel", "PriorityLevel")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_priority_level_traslation_priority_level_priority_level_id");
