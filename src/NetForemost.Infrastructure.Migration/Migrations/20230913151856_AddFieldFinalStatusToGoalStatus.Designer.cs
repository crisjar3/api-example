...
namespace NetForemost.Infrastructure.Migrations.Migrations
{
    ...
    [Migration("20230913151856_AddFieldFinalStatusToGoalStatus")]
    partial class AddFieldFinalStatusToGoalStatus
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.TimeHistoryTrackings.TimeHistoryTracking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_time_history_tracking");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_time_history_tracking_user_id");

                    b.ToTable("time_history_tracking", (string)null);
                });

            modelBuilder.Entity("NetForemost.Core.Entities.TimeTrakings.BlockTimeTracking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("TimeHistoryTrackingId")
                        .HasColumnType("integer")
                        .HasColumnName("time_history_tracking_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_block_time_tracking");

                    b.HasIndex("DeviceId")
                        .HasDatabaseName("ix_block_time_tracking_device_id");

                    b.HasIndex("TaskId")
                        .HasDatabaseName("ix_block_time_tracking_task_id");

                    b.HasIndex("TimeHistoryTrackingId")
                        .HasDatabaseName("ix_block_time_tracking_time_history_tracking_id");

                    b.ToTable("block_time_tracking", (string)null);
                });
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.TimeTrakings.TrackingBlockImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("BlockTimeTrackingId")
                        .HasColumnType("integer")
                        .HasColumnName("block_time_tracking_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_tracking_block_image");

                    b.HasIndex("BlockTimeTrackingId")
                        .HasDatabaseName("ix_tracking_block_image_block_time_tracking_id");

                    b.ToTable("tracking_block_image", (string)null);
                });
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.TimeHistoryTrackings.TimeHistoryTracking", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.Users.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_time_history_tracking_users_user_id");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.TimeTrakings.BlockTimeTracking", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.TimeTrakings.Device", "Device")
                        ...
                        .HasConstraintName("fk_block_time_tracking_devices_device_id");
                    ...
                    b.HasOne("NetForemost.Core.Entities.Tasks.Task", "Task")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_block_time_tracking_task_task_id");

                    b.HasOne("NetForemost.Core.Entities.TimeHistoryTrackings.TimeHistoryTracking", "TimeHistoryTracking")
                        .WithMany("BlockTimeTrackings")
                        .HasForeignKey("TimeHistoryTrackingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_block_time_tracking_time_history_tracking_time_history_trac");

                    b.Navigation("Device");

                    b.Navigation("Task");

                    b.Navigation("TimeHistoryTracking");
                });
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.TimeTrakings.TrackingBlockImage", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.TimeTrakings.BlockTimeTracking", "BlockTimeTracking")
                        .WithMany("Images")
                        .HasForeignKey("BlockTimeTrackingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_tracking_block_image_block_time_tracking_block_time_trackin");

                    b.Navigation("BlockTimeTracking");
                });
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.TimeHistoryTrackings.TimeHistoryTracking", b =>
                {
                    b.Navigation("BlockTimeTrackings");
                });
