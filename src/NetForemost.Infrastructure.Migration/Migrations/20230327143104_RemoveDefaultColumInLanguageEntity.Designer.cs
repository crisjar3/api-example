...
namespace NetForemost.Infrastructure.Migrations.Migrations
{
    ...
    [Migration("20230327143104_RemoveDefaultColumInLanguageEntity")]
    partial class RemoveDefaultColumInLanguageEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Goals.GoalExtraMile", b =>
                {
                    ...
                    b.Property<DateTime>("ExtraMileEndDate")
                        .HasColumnType("timestamp without time zone")
                        .HasColumnName("extra_mile_end_date");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Teams.JobOfferJobRole", b =>
                {
                    ...
                    b.HasIndex("JobOfferId")
                        .HasDatabaseName("ix_job_offer_job_role_job_offer_id");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Teams.JobOfferJobRoleSkill", b =>
                {
                    ...
                    b.Property<int>("JobOfferJobRoleId")
                        .HasColumnType("integer")
                        .HasColumnName("job_offer_job_role_id");
                    ...
                    b.HasIndex("JobOfferJobRoleId")
                        .HasDatabaseName("ix_job_offer_job_role_skill_job_offer_job_role_id");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Teams.JobOfferJobRole", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.Teams.JobOffer", "JobOffer")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_job_offer_job_role_job_offer_job_offer_id");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Teams.JobOfferJobRoleSkill", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.Teams.JobOfferJobRole", "JobOfferJobRole")
                        .WithMany("JobOfferJobRoleSkills")
                        .HasForeignKey("JobOfferJobRoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_job_offer_job_role_skill_job_offer_job_role_job_offer_job_r");
