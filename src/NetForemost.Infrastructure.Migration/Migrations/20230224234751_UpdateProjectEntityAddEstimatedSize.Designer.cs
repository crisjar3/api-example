...
namespace NetForemost.Infrastructure.Migrations.Migrations
{
    ...
    [Migration("20230224234751_UpdateProjectEntityAddEstimatedSize")]
    partial class UpdateProjectEntityAddEstimatedSize
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Companies.CompanyUser", b =>
                {
                    ...
                    b.HasIndex("TeammateRequestId")
                        .HasDatabaseName("ix_company_user_teammate_request_id");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Teams.TeammateRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<DateTime>("EndRequest")
                        .HasColumnType("timestamp without time zone")
                        .HasColumnName("end_request");

                    b.Property<bool>("HaveDevelopmentTeam")
                        .HasColumnType("boolean")
                        .HasColumnName("have_development_team");

                    b.Property<string>("OfficePolicy")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("office_policy");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_teammate_request");

                    b.HasIndex("CityId")
                        .HasDatabaseName("ix_teammate_request_city_id");

                    b.HasIndex("CompanyId")
                        .HasDatabaseName("ix_teammate_request_company_id");

                    b.HasIndex("CountryId")
                        .HasDatabaseName("ix_teammate_request_country_id");

                    b.ToTable("teammate_request", (string)null);
                });

            modelBuilder.Entity("NetForemost.Core.Entities.Teams.TeammateRequestBenefit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_teammate_request_benefit");

                    b.HasIndex("BenefitId")
                        .HasDatabaseName("ix_teammate_request_benefit_benefit_id");

                    b.HasIndex("TeammateRequestId")
                        .HasDatabaseName("ix_teammate_request_benefit_teammate_request_id");

                    b.ToTable("teammate_request_benefit", (string)null);
                });

            modelBuilder.Entity("NetForemost.Core.Entities.Teams.TeammateRequestJobRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_teammate_request_job_role");

                    b.HasIndex("JobRoleId")
                        .HasDatabaseName("ix_teammate_request_job_role_job_role_id");

                    b.HasIndex("SeniorityId")
                        .HasDatabaseName("ix_teammate_request_job_role_seniority_id");

                    b.HasIndex("TeammateRequestId")
                        .HasDatabaseName("ix_teammate_request_job_role_teammate_request_id");

                    b.ToTable("teammate_request_job_role", (string)null);
                });

            modelBuilder.Entity("NetForemost.Core.Entities.Teams.TeammateRequestJobRoleSkill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("TeammateRequestJobRoleId")
                        .HasColumnType("integer")
                        .HasColumnName("teammate_request_job_role_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_teammate_request_job_role_skill");

                    b.HasIndex("SkillId")
                        .HasDatabaseName("ix_teammate_request_job_role_skill_skill_id");

                    b.HasIndex("TeammateRequestJobRoleId")
                        .HasDatabaseName("ix_teammate_request_job_role_skill_teammate_request_job_role_id");

                    b.ToTable("teammate_request_job_role_skill", (string)null);
                });
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Companies.CompanyUser", b =>
                {
                    ...
                    b.HasOne("NetForemost.Core.Entities.Teams.TeammateRequest", "TeammateRequest")
                        .WithMany()
                        .HasForeignKey("TeammateRequestId")
                        .HasConstraintName("fk_company_user_teammate_request_teammate_request_id");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Teams.TeammateRequest", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.Countries.City", "City")
                        .WithMany("Benefits")
                        .HasForeignKey("CityId")
                        .HasConstraintName("fk_teammate_request_cities_city_id");
                    ...
                    b.HasOne("NetForemost.Core.Entities.Companies.Company", "Company")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_teammate_request_companies_company_id");

                    b.HasOne("NetForemost.Core.Entities.Countries.Country", "Country")
                        .WithMany("Benefits")
                        .HasForeignKey("CountryId")
                        .HasConstraintName("fk_teammate_request_countries_country_id");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Teams.TeammateRequestBenefit", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.Benefits.Benefit", "Benefit")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_teammate_request_benefit_benefit_benefit_id");
                    ...
                    b.HasOne("NetForemost.Core.Entities.Teams.TeammateRequest", "TeammateRequest")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_teammate_request_benefit_teammate_request_teammate_request_");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Teams.TeammateRequestJobRole", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.JobRoles.JobRole", "JobRole")
                        .WithMany("TeammateRequestJobRoles")
                        .HasForeignKey("JobRoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_teammate_request_job_role_job_role_job_role_id");
                    ...
                    b.HasOne("NetForemost.Core.Entities.Seniorities.Seniority", "Seniority")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_teammate_request_job_role_seniority_seniority_id");
                    ...
                    b.HasOne("NetForemost.Core.Entities.Teams.TeammateRequest", "TeammateRequest")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_teammate_request_job_role_teammate_request_teammate_request");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Teams.TeammateRequestJobRoleSkill", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.Skills.Skill", "Skill")
                        .WithMany("TeammateRequestJobRoleSkills")
                        .HasForeignKey("SkillId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_teammate_request_job_role_skill_skill_skill_id");

                    b.HasOne("NetForemost.Core.Entities.Teams.TeammateRequestJobRole", "TeammateRequestJobRole")
                        .WithMany("TeammateRequestJobRoleSkills")
                        .HasForeignKey("TeammateRequestJobRoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_teammate_request_job_role_skill_teammate_request_job_role_t");

                    b.Navigation("Skill");

                    b.Navigation("TeammateRequestJobRole");
                });
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Users.UserSettings", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.TimeZones.TimeZone", "TimeZone")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_settings_time_zones_time_zone_id");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.JobRoles.JobRole", b =>
                {
                    ...
                    b.Navigation("TeammateRequestJobRoles");
                });
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Skills.Skill", b =>
                {
                    b.Navigation("TeammateRequestJobRoleSkills");
                });
