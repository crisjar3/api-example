...
namespace NetForemost.Infrastructure.Migrations.Migrations
{
    ...
    [Migration("20230307151904_UpdateTeammateRequestToJobOffer")]
    partial class UpdateTeammateRequestToJobOffer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Teams.JobOffer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Teams.JobOfferBenefit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("TeammateRequestId")
                        .HasDatabaseName("ix_job_offer_benefit_teammate_request_id");

                    b.ToTable("job_offer_benefit", (string)null);
                });

            modelBuilder.Entity("NetForemost.Core.Entities.Teams.JobOfferJobRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_job_offer_job_role");

                    b.HasIndex("JobRoleId")
                        .HasDatabaseName("ix_job_offer_job_role_job_role_id");

                    b.HasIndex("SeniorityId")
                        .HasDatabaseName("ix_job_offer_job_role_seniority_id");

                    b.HasIndex("TeammateRequestId")
                        .HasDatabaseName("ix_job_offer_job_role_teammate_request_id");

                    b.ToTable("job_offer_job_role", (string)null);
                });

            modelBuilder.Entity("NetForemost.Core.Entities.Teams.JobOfferJobRoleSkill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_job_offer_job_role_skill");

                    b.HasIndex("SkillId")
                        .HasDatabaseName("ix_job_offer_job_role_skill_skill_id");

                    b.HasIndex("TeammateRequestJobRoleId")
                        .HasDatabaseName("ix_job_offer_job_role_skill_teammate_request_job_role_id");

                    b.ToTable("job_offer_job_role_skill", (string)null);
                });
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Companies.CompanyUser", b =>
                {
                    ...
                    b.HasOne("NetForemost.Core.Entities.Teams.JobOffer", "JobOffer")
                        .WithMany()
                        .HasForeignKey("JobOfferId")
                        .HasConstraintName("fk_company_user_teammate_request_job_offer_id");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Teams.JobOffer", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.Countries.City", "City")
                        .WithMany("Benefits")
                        .HasForeignKey("CityId")
                        .HasConstraintName("fk_job_offer_city_city_id");
                    ...
                    b.HasOne("NetForemost.Core.Entities.Companies.Company", "Company")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_job_offer_company_company_id");

                    b.HasOne("NetForemost.Core.Entities.Countries.Country", "Country")
                        .WithMany("Benefits")
                        .HasForeignKey("CountryId")
                        .HasConstraintName("fk_job_offer_country_country_id");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Teams.JobOfferBenefit", b =>
                {
                    ...
                    b.HasOne("NetForemost.Core.Entities.Teams.JobOffer", "TeammateRequest")
                        .WithMany("Benefits")
                        .HasForeignKey("TeammateRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_job_offer_benefit_job_offer_teammate_request_id");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Teams.JobOfferJobRole", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.JobRoles.JobRole", "JobRole")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_job_offer_job_role_job_role_job_role_id");
                    ...
                    b.HasOne("NetForemost.Core.Entities.Seniorities.Seniority", "Seniority")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_job_offer_job_role_seniority_seniority_id");
                    ...
                    b.HasOne("NetForemost.Core.Entities.Teams.JobOffer", "TeammateRequest")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_job_offer_job_role_job_offer_teammate_request_id");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Teams.JobOfferJobRoleSkill", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.Skills.Skill", "Skill")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_job_offer_job_role_skill_skill_skill_id");

                    b.HasOne("NetForemost.Core.Entities.Teams.JobOfferJobRole", "TeammateRequestJobRole")
                        .WithMany("TeammateRequestJobRoleSkills")
                        .HasForeignKey("TeammateRequestJobRoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_job_offer_job_role_skill_job_offer_job_role_teammate_reques");
