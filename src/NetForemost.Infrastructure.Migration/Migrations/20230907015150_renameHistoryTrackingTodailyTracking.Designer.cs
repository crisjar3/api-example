...
namespace NetForemost.Infrastructure.Migrations.Migrations
{
    ...
    [Migration("20230907015150_renameHistoryTrackingTodailyTracking")]
    partial class renameHistoryTrackingTodailyTracking
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.TimeHistoryTrackings.DailyTracking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_daily_tracking");

                    b.HasIndex("OwnerId")
                        .HasDatabaseName("ix_daily_tracking_owner_id");

                    b.ToTable("daily_tracking", (string)null);
                });

            modelBuilder.Entity("NetForemost.Core.Entities.TimeTrakings.BlockMonitoring", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_block_monitoring");

                    b.HasIndex("BlockTimeTrackingId")
                        .HasDatabaseName("ix_block_monitoring_block_time_tracking_id");

                    b.ToTable("block_monitoring", (string)null);
                });
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.TimeTrakings.BlockTimeTracking", b =>
                {
                    ...
                    b.Property<int>("DailyTrackingId")
                        .HasColumnType("integer")
                        .HasColumnName("daily_tracking_id");
                    ...
                    b.HasIndex("DailyTrackingId")
                        .HasDatabaseName("ix_block_time_tracking_daily_tracking_id");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.TimeHistoryTrackings.DailyTracking", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.Users.User", "Owner")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_daily_tracking_users_owner_id");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.TimeTrakings.BlockMonitoring", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.TimeTrakings.BlockTimeTracking", "BlockTimeTracking")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_block_monitoring_block_time_trackings_block_time_tracking_id");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.TimeTrakings.BlockTimeTracking", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.TimeHistoryTrackings.DailyTracking", "DailyTracking")
                        .WithMany("BlockTimeTrackings")
                        .HasForeignKey("DailyTrackingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_block_time_tracking_daily_tracking_daily_tracking_id");
