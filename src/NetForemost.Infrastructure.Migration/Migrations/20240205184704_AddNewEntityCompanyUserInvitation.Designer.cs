...
namespace NetForemost.Infrastructure.Migrations.Migrations
{
    ...
    [Migration("20240205184704_AddNewEntityCompanyUserInvitation")]
    partial class AddNewEntityCompanyUserInvitation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Companies.CompanySettings", b =>
                {
                    ...
                    b.Property<int?>("LateHoursInUsersTimeZoneAfter")
                        .HasColumnType("integer")
                        .HasColumnName("late_hours_in_users_time_zone_after");

                    b.Property<int?>("TooManyHoursPerDay")
                        .HasColumnType("integer")
                        .HasColumnName("too_many_hours_per_day");
                    ...
                    b.Property<int?>("WorkOutsideShiftPerDayLongerThan")
                        .HasColumnType("integer")
                        .HasColumnName("work_outside_shift_per_day_longer_than");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Companies.CompanyUser", b =>
                {
                    ...
                    b.HasIndex("JobRoleId")
                        .HasDatabaseName("ix_company_user_job_role_id");

                    b.HasIndex("RoleId")
                        .HasDatabaseName("ix_company_user_role_id");

                    b.HasIndex("TimeZoneId")
                        .HasDatabaseName("ix_company_user_time_zone_id");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Companies.CompanyUserInvitation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("EmailInvited")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("email_invited");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_company_user_invitation");

                    b.HasIndex("CompanyId")
                        .HasDatabaseName("ix_company_user_invitation_company_id");

                    b.HasIndex("JobRoleId")
                        .HasDatabaseName("ix_company_user_invitation_job_role_id");

                    b.HasIndex("RoleId")
                        .HasDatabaseName("ix_company_user_invitation_role_id");

                    b.ToTable("company_user_invitation", (string)null);
                });
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Goals.Goal", b =>
                {
                    ...
                    b.Property<double>("TimeSpentInSecond")
                        .HasColumnType("double precision")
                        .HasColumnName("time_spent_in_second");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Projects.Project", b =>
                {
                    ...
                    b.Property<bool>("IsAccessibleForEveryone")
                        .HasColumnType("boolean")
                        .HasColumnName("is_accessible_for_everyone");
                    ...
                    b.Property<string>("ProjectImageUrl")
                        .HasColumnType("text")
                        .HasColumnName("project_image_url");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Projects.ProjectAvatar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_project_avatar");

                    b.HasIndex("ProjectId")
                        .HasDatabaseName("ix_project_avatar_project_id");

                    b.ToTable("project_avatar", (string)null);
                });
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Projects.ProjectCompanyUserInvitation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("CompanyUserInvitationId")
                        .HasColumnType("integer")
                        .HasColumnName("company_user_invitation_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_project_company_user_invitation");

                    b.HasIndex("CompanyUserInvitationId")
                        .HasDatabaseName("ix_project_company_user_invitation_company_user_invitation_id");

                    b.HasIndex("ProjectId")
                        .HasDatabaseName("ix_project_company_user_invitation_project_id");

                    b.ToTable("project_company_user_invitation", (string)null);
                });
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Timer.DailyMonitoringBlock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("DailyTimeBlockId")
                        .HasColumnType("integer")
                        .HasColumnName("daily_time_block_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_daily_monitoring_block");

                    b.HasIndex("DailyTimeBlockId")
                        .HasDatabaseName("ix_daily_monitoring_block_daily_time_block_id");

                    b.ToTable("daily_monitoring_block", (string)null);
                });

            modelBuilder.Entity("NetForemost.Core.Entities.Timer.DailyTimeBlock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_daily_time_block");

                    b.HasIndex("DeviceId")
                        .HasDatabaseName("ix_daily_time_block_device_id");

                    b.HasIndex("OwnerId")
                        .HasDatabaseName("ix_daily_time_block_owner_id");

                    b.HasIndex("TaskId")
                        .HasDatabaseName("ix_daily_time_block_task_id");

                    b.ToTable("daily_time_block", (string)null);
                });

            modelBuilder.Entity("NetForemost.Core.Entities.Timer.Device", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Timer.DeviceType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Users.UserSettings", b =>
                {
                    ...
                    b.HasIndex("LanguageId")
                        .HasDatabaseName("ix_user_settings_language_id");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Companies.CompanyUser", b =>
                {
                    ...
                    b.HasOne("NetForemost.Core.Entities.JobRoles.JobRole", "JobRole")
                        ...
                        .HasConstraintName("fk_company_user_work_roles_job_role_id");
                    ...
                    b.HasOne("NetForemost.Core.Entities.TimeZones.TimeZone", "TimeZone")
                        .WithMany()
                        .HasForeignKey("TimeZoneId")
                        .HasConstraintName("fk_company_user_time_zones_time_zone_id");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Companies.CompanyUserInvitation", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.Companies.Company", "Company")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_company_user_invitation_company_company_id");
                    ...
                    b.HasOne("NetForemost.Core.Entities.JobRoles.JobRole", "JobRole")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_company_user_invitation_work_roles_job_role_id");
                    ...
                    b.HasOne("NetForemost.Core.Entities.Roles.Role", "Role")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_company_user_invitation_roles_role_id");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Goals.Goal", b =>
                {
                    ...
                    b.HasOne("NetForemost.Core.Entities.Projects.ProjectCompanyUser", "Owner")
                        .WithMany()
                        .HasForeignKey("OwnerId")
                        .HasConstraintName("fk_goal_project_company_users_owner_id");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Projects.ProjectAvatar", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.Projects.Project", "Project")
                        .WithMany("ProjectAvatars")
                        .HasForeignKey("ProjectId")
                        .HasConstraintName("fk_project_avatar_project_project_id");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Projects.ProjectCompanyUserInvitation", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.Companies.CompanyUserInvitation", "CompanyUserInvitation")
                        .WithMany("ProjectCompanyUserInvitations")
                        .HasForeignKey("CompanyUserInvitationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_project_company_user_invitation_company_user_invitation_com");
                    ...
                    b.HasOne("NetForemost.Core.Entities.Projects.Project", "Project")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_project_company_user_invitation_project_project_id");

                    b.Navigation("CompanyUserInvitation");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Tasks.Task", b =>
                {
                    ...
                    b.HasOne("NetForemost.Core.Entities.Projects.ProjectCompanyUser", "Owner")
                        .WithMany()
                        .HasForeignKey("OwnerId")
                        .HasConstraintName("fk_task_project_company_user_owner_id");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Timer.DailyMonitoringBlock", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.Timer.DailyTimeBlock", "DailyTimeBlock")
                        .WithMany("Monitorings")
                        .HasForeignKey("DailyTimeBlockId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_daily_monitoring_block_daily_time_block_daily_time_block_id");

                    b.Navigation("DailyTimeBlock");
                });

            modelBuilder.Entity("NetForemost.Core.Entities.Timer.DailyTimeBlock", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.Timer.Device", "Device")
                        .WithMany()
                        .HasForeignKey("DeviceId")
                        .HasConstraintName("fk_daily_time_block_devices_device_id");

                    b.HasOne("NetForemost.Core.Entities.Projects.ProjectCompanyUser", "Owner")
                        .WithMany()
                        .HasForeignKey("OwnerId")
                        .HasConstraintName("fk_daily_time_block_project_company_users_owner_id");
                    ...
                    b.HasOne("NetForemost.Core.Entities.Tasks.Task", "Task")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_daily_time_block_work_tasks_task_id");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Timer.Device", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.Timer.DeviceType", "DeviceType")
                        .WithMany()
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Users.UserSettings", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.Languages.Language", "Language")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_settings_languages_language_id");

                    b.HasOne("NetForemost.Core.Entities.Users.User", "User")
                        .WithOne("UserSettings")
                        .HasForeignKey("NetForemost.Core.Entities.Users.UserSettings", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Companies.CompanyUserInvitation", b =>
                {
                    b.Navigation("ProjectCompanyUserInvitations");
                });
