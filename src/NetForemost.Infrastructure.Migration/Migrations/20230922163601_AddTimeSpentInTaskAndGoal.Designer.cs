...
namespace NetForemost.Infrastructure.Migrations.Migrations
{
    ...
    [Migration("20230922163601_AddTimeSpentInTaskAndGoal")]
    partial class AddTimeSpentInTaskAndGoal
    {
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Timer.DailyMonitoringBlock", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.Timer.DailyTimeBlock", "DailyTimeBlock")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_daily_monitoring_block_block_time_trackings_daily_time_bloc");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Timer.DailyTimeBlock", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.Timer.DailyEntry", "DailyEntry")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_daily_time_block_daily_entry_daily_entry_id");
                    ...
                    b.HasOne("NetForemost.Core.Entities.Tasks.Task", "Task")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_daily_time_block_task_task_id");
