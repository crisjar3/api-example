...
namespace NetForemost.Infrastructure.Migrations.Migrations
{
    ...
    [Migration("20230131135353_CreateWorkRoleAndWorkRoleTranslationsEntities")]
    partial class CreateWorkRoleAndWorkRoleTranslationsEntities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.WorkRoles.WorkRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("WorkRoleCategoryId")
                        .HasColumnType("integer")
                        .HasColumnName("work_role_category_id");

                    b.HasKey("Id")
                        .HasName("pk_work_role");

                    b.HasIndex("WorkRoleCategoryId")
                        .HasDatabaseName("ix_work_role_work_role_category_id");

                    b.ToTable("work_role", (string)null);
                });

            modelBuilder.Entity("NetForemost.Core.Entities.WorkRoles.WorkRoleCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_work_role_category");

                    b.ToTable("work_role_category", (string)null);
                });

            modelBuilder.Entity("NetForemost.Core.Entities.WorkRoles.WorkRoleCategoryTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_work_role_category_translation");

                    b.HasIndex("LanguageId")
                        .HasDatabaseName("ix_work_role_category_translation_language_id");

                    b.HasIndex("WorkRoleCategoryId")
                        .HasDatabaseName("ix_work_role_category_translation_work_role_category_id");

                    b.ToTable("work_role_category_translation", (string)null);
                });

            modelBuilder.Entity("NetForemost.Core.Entities.WorkRoles.WorkRoleTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("WorkRoleId")
                        .HasColumnType("integer")
                        .HasColumnName("work_role_id");

                    b.HasKey("Id")
                        .HasName("pk_work_role_translation");

                    b.HasIndex("LanguageId")
                        .HasDatabaseName("ix_work_role_translation_language_id");

                    b.HasIndex("WorkRoleId")
                        .HasDatabaseName("ix_work_role_translation_work_role_id");

                    b.ToTable("work_role_translation", (string)null);
                });
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.WorkRoles.WorkRole", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.WorkRoles.WorkRoleCategory", "WorkRoleCategory")
                        .WithMany("WorkRoles")
                        .HasForeignKey("WorkRoleCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_work_role_work_role_categories_work_role_category_id");

                    b.Navigation("WorkRoleCategory");
                });
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.WorkRoles.WorkRoleCategoryTranslation", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.Languages.Language", "Language")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_work_role_category_translation_language_language_id");
                    ...
                    b.HasOne("NetForemost.Core.Entities.WorkRoles.WorkRoleCategory", "WorkRoleCategory")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_work_role_category_translation_work_role_category_work_role");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.WorkRoles.WorkRoleTranslation", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.Languages.Language", "Language")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_work_role_translation_language_language_id");

                    b.HasOne("NetForemost.Core.Entities.WorkRoles.WorkRole", "WorkRole")
                        .WithMany()
                        .HasForeignKey("WorkRoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_work_role_translation_work_role_work_role_id");
