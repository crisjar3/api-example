...
namespace NetForemost.Infrastructure.Migrations.Migrations
{
    ...
    [Migration("20231103005908_AddRelationshipBetweenProjectCompanyUserEntityAndDailyTimeBlockEntity")]
    partial class AddRelationshipBetweenProjectCompanyUserEntityAndDailyTimeBlockEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Timer.DailyEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<double>("TotalTrackingTime")
                        .HasColumnType("double precision")
                        .HasColumnName("total_tracking_time");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_daily_entry");

                    b.HasIndex("OwnerId")
                        .HasDatabaseName("ix_daily_entry_owner_id");

                    b.ToTable("daily_entry", (string)null);
                });
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Timer.DailyTimeBlock", b =>
                {
                    ...
                    b.HasIndex("DailyEntryId")
                        .HasDatabaseName("ix_daily_time_block_daily_entry_id");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Timer.DailyEntry", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.Users.User", "Owner")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_daily_entry_users_owner_id");
            ...
            modelBuilder.Entity("NetForemost.Core.Entities.Timer.DailyTimeBlock", b =>
                {
                    b.HasOne("NetForemost.Core.Entities.Timer.DailyEntry", "DailyEntry")
                        .WithMany("DailyTimeBlocks")
                        .HasForeignKey("DailyEntryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_daily_time_block_time_history_tracking_daily_entry_id");
